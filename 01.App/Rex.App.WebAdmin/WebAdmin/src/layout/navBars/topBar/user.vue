  ...
  <div class="layout-navbars-breadcrumb-user pr15" :style="{ flex: layoutUserFlexNum }">
    ...
    >
      <div class="layout-navbars-breadcrumb-user-icon">
        <i class="iconfont icon-zitidaxiao" :title="$t('message.user.title0')"></i>
      </div>
      <template #dropdown>
        <el-dropdown-menu>
    ...
    >
      <div class="layout-navbars-breadcrumb-user-icon">
        <i class="iconfont icon-yuyanqiehuan" :title="$t('message.user.title1')"></i>
      </div>
      <template #dropdown>
        <el-dropdown-menu>
    ...
    <div class="layout-navbars-breadcrumb-user-icon" @click="onLayoutSetingClick">
      <i class="icon-bujupeizhi iconfont" :title="$t('message.user.title3')"></i>
    </div>
    <div
    ...
    <div class="layout-navbars-breadcrumb-user-icon mr10" @click="onScreenfullClick">
      <i
        ...
        "
        :class="!state.isScreenfull ? 'icon-quanpingkai' : 'icon-quanpingguan'"
      ></i>
    </div>
    <el-dropdown :show-timeout="70" :hide-timeout="50" @command="onHandleCommandClick">
      <span class="layout-navbars-breadcrumb-user-link">
        <img
          :src="currentSysUsers.photo"
          class="layout-navbars-breadcrumb-user-link-photo mr5"
        />
        {{ currentSysUsers.userName }}
...
const onHandleCommandClick = (path: string) => {
  if (path === "logOut") {
    ...
    window.open("https://gitee.com/zhuyongzhengs/Rex.ShopMicroService.Sample");
  } else {
    router.push(path);
  }
};
