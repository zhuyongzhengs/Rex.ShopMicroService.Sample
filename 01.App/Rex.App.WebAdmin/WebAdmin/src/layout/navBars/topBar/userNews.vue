...
const state = reactive({
	newsList: [
		{
			label: '关于版本发布的通知',
			value: 'ABP.MicroServer，基于 vue3 + CompositionAPI + typescript + vite + element plus，正式发布时间：2023年01月01日！',
			time: '2023-01-01',
		},
		{
			label: '系统上线通知',
			value: '2022年12月05日正式上线，欢迎使用！',
			time: '2022-12-05',
		}
	]
});
...
const onGoToGiteeClick = () => {
	window.open('https://gitee.com/zhuyongzhengs/Rex.ShopMicroService.Sample.git');
};
</script>
