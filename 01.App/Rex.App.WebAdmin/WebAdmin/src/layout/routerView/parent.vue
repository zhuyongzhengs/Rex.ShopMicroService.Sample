...
onMounted(() => {
  getIframeListRoutes();
  // https://gitee.com/zhuyongzhengs/Rex.ShopMicroService.Sample/issues/I58U75
  // https://gitee.com/zhuyongzhengs/Rex.ShopMicroService.Sample/issues/I59RXK
  // https://gitee.com/zhuyongzhengs/Rex.ShopMicroService.Sample/pulls/40
  nextTick(() => {
    setTimeout(() => {
...
// https://toscode.gitee.com/zhuyongzhengs/abp-micro-server-samples/pulls/38/files
watch(
  () => route.fullPath,
  () => {
