...
export default {
	router: {
		...
		systemMenu: '選單管理',
		systemRole: '角色管理',
		systemManagePermissions: '管理角色',
		systemOrganizationUnit: '組織單元',
		systemOrganizationUnitManagingUser: '管理組織結構用戶',
		systemOrganizationUnitManagingRole: '管理組織結構角色',
		systemUser: '用戶管理',
		sysLogManagement: '日誌管理',
		systemAuditLogging: '審計日誌',
		systemSecurityLog: '登録日誌',
		member: '會員管理',
		memberUserGrade: '用戶等級',
		memberUserWeChat: '微信用戶管理',
		memberSysUser: '註冊用戶管理',
		good: '商品管理',
		goods: '商品列表',
		goodsCreate: '新增『商品信息』',
		goodsUpdate: '修改『商品信息』',
		goodsLook: '查看『商品信息』',
		serviceGood: '服務商品',
		serviceGoodCreate: '新增『服務商品』',
		serviceGoodUpdate: '修改『服務商品』',
		serviceGoodLook: '查看『服務商品』',
		brand: '品牌',
		goodCategory: '商品分類',
		goodParam: '參數模型',
		goodTypeSpec: 'SKU模型',
		...
		layout: '版面設計',
		copy: '复制',
		operationManage: '運營管理',
		articleManage: '文章管理',
		articles: '文章列表',
		articleType: '文章分類',

		promotion: '促銷中心',
		globalPromotion: '全局促銷',
		setParameters: '設置參數',
		coupon: '優惠劵',
		couponlist: '卷碼列表',
		groupSeckill: '商品秒殺',
		...
		serviceDescription: '商城服務描述',
		platformSetting: '平臺設置',
		platformManage: '平臺管理',
		logistics: '物流公司',
		ship: '配送方式',
