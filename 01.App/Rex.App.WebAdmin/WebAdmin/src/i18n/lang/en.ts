...
export default {
	router: {
		...
		tenantManageFeatures: 'tenantManageFeatures',
		tenantManageConnectionStrings: 'tenantManageConnectionStrings',
		systemSelect: 'select',
		systemCreate: 'add',
		systemUpdate: 'edit',
		systemDelete: 'delete',
		...
		systemManagePermissions: 'systemManagePermissions',
		systemOrganizationUnit: 'systemOrganizationUnit',
		systemOrganizationUnitManagingUser: 'systemOrganizationUnitManagingUser',
		systemOrganizationUnitManagingRole: 'systemOrganizationUnitManagingRole',
		systemUser: 'systemUser',
		sysLogManagement: 'sysLogManagement',
		systemAuditLogging: 'systemAuditLogging',
		systemSecurityLog: 'systemSecurityLog',
		member: 'member',
		memberUserGrade: 'memberUserGrade',
		memberUserWeChat: 'memberUserWeChat',
		memberSysUser: 'memberSysUser',
		good: 'good',
		goods: 'goods',
		goodsCreate: 'create『goods』',
		goodsUpdate: 'update『goods』',
		goodsLook: 'look『goods』',
		serviceGood: 'serviceGood',
		serviceGoodCreate: 'serviceGoodCreate',
		serviceGoodUpdate: 'serviceGoodUpdate',
		serviceGoodLook: 'serviceGoodLook',
		brand: 'brand',
		goodCategory: 'goodCategory',
		goodParam: 'goodParam',
		goodTypeSpec: 'goodTypeSpec',
		...
		groupSeckill: 'groupSeckill',

		pinTuanManage: 'pinTuanManage',
