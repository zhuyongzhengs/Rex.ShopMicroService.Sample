...
public class Program
{
    public static async Task<int> Main(string[] args)
    {
        ...
        Log.Logger = new LoggerConfiguration()
            ...
            {
                opts.DataStream = new DataStreamName("logs", "rex-shop", "good");
        ...
        try
        {
            Console.Title = "【Rex商城】商品服务";
            Log.Information("Starting Rex.GoodService.HttpApi.Host.");
            ...
            builder.AddNpgsqlDataSource("Goods");
            builder.AddMongoDBClient("AbpAuditLogging");

            await builder.AddApplicationAsync<GoodServiceHttpApiHostModule>();
