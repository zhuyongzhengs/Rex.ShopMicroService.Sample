...
public class Program
{
    public static async Task<int> Main(string[] args)
    {
        ...
        Log.Logger = new LoggerConfiguration()
            ...
            {
                opts.DataStream = new DataStreamName("logs", "rex-shop", "payment");
        ...
        try
        {
            Console.Title = "【Rex商城】支付服务";
            Log.Information("Starting Rex.PaymentService.HttpApi.Host.");
            ...
            builder.AddNpgsqlDataSource("Payments");
