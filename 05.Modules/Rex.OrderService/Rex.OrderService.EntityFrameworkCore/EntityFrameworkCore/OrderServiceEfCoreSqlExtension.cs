...
namespace Rex.OrderService.EntityFrameworkCore
{
    ...
    /// EF Core执行SQL语句扩展
    /// </summary>
    public static class OrderServiceEfCoreSqlExtension
    {
        /// <summary>
        /// 执行查询操作，返回DataTable
        /// </summary>
        ...
        public static DataTable ExecuteQuery(this OrderServiceDbContext dbContext, string commandText, CommandType commandType, params DbParameter[] parameters)
        {
