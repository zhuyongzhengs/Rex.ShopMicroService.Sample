...
namespace Rex.OrderService.Orders
{
    ...
    /// 查询订单
    /// </summary>
    public class GetOrderInput : PagedAndSortedResultRequestDto
    {
        /// <summary>
        /// 订单号
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// 枚举：GlobalOrderStatusType
        /// 1：待付款、2：待发货、3：待收货、4：待评价、5：已评价、6：已完成、7：已取消、8：部分发货
        /// <remarks>
        public int? GlobalOrderStatus { get; set; }
