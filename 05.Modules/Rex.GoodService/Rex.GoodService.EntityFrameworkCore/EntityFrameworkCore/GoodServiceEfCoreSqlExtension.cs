...
namespace Rex.GoodService.EntityFrameworkCore
{
    ...
    /// EF Core执行SQL语句扩展
    /// </summary>
    public static class GoodServiceEfCoreSqlExtension
    {
        /// <summary>
        /// 执行查询操作，返回DataTable
        /// </summary>
        ...
        public static DataTable ExecuteQuery(this GoodServiceDbContext dbContext, string commandText, CommandType commandType, params DbParameter[] parameters)
        {
